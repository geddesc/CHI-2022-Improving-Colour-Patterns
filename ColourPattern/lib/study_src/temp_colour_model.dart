...
final List<Color> deepred = const [
  ...
  TempColourModel.protan({this.maxTargetColours = 3, this.maxConfusionColours = 10, this.maxDistractorColours = 10}) {
    isProtan = true;
    _currentRound = 0;
    confusionSet = {
      [
  ...
  TempColourModel.deutan({this.maxTargetColours = 1, this.maxConfusionColours = 1, this.maxDistractorColours = 2}) {
    isProtan = false;
    _currentRound = 0;
    confusionSet = {
      [
  ...
  _playGame() {
    ...
    for (int i = 0; i < numTargetColours; i++) {
      var tempList = (temp[nameVal]['list'] as List<Color>);
    ...
    temp.remove(temp[nameVal]);

    int numConfusionColours = maxConfusionColours + (maxTargetColours - numTargetColours);
    ...
    if(targetColourName == 'red' || targetColourName == 'brown' || targetColourName == 'orange' || targetColourName == 'darkbrown' ||  targetColourName == 'darkorange' || targetColourName == ' red ') {
      distractList = [...darkBlue, ...babyBlue, ...seaGreen, ...purple, ...blue, ...royalBlue, ...teal, ...yellow, ...neongreen,];
    } else if(targetColourName == 'green' || targetColourName == 'yellow' || targetColourName == 'darkgreen') {
      distractList = [...darkBlue, ...babyBlue, ...purple, ...blue, ...royalBlue, ...teal, ...grey, ...darkPink];
    } else if(targetColourName == 'teal' || targetColourName == 'grey' || targetColourName == 'pink' ) {
      distractList = [...darkBlue, ...purple, ...blue, ...royalBlue, ...red, ...green, ...yellow, ...neongreen, ...darkorange, ...darkgreen, ...darkbrown, ...darkYellow, ...burgundy,  ...darkorange, ...brown, ...deepred,];
    } else {
      distractList = [...seaGreen, ...green, ...yellow, ...neongreen,  ...darkYellow, ...burgundy,   ...deepred, ...teal, ...darkPink, ...grey];
